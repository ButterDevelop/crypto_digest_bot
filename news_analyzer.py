...
INSTRUCTIONS = (
    ...
    "judicial decisions, large institutional entries/exits). "
    "If there are specific dates/times, include them in the text (e.g. '... at 2025-10-15 14:00 UTC+0') - this is the macro block.\n"
    ...
    "    - text     - concise, but clear description of the news. If the event has a specific date/time, ALWAYS include it in UTC+0 (e.g. 'Meeting at 14:00 UTC+0') inside the text;\n"
